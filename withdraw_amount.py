...
class application:
    def __init__(self,master):
        ...
        self.heading=Label(self.top,text="Withdraw Amount",font="arial 18 bold",bg="white")
        ...
        self.wdr= Button(self.bottom, text=" Withdraw ", font="arial 15 bold", width="15", command=withdraw)
        self.wdr.place(x=300 , y=330)
